...
class Repository:
    ...
    def start_release(self, work_branch: str, release_branch: str, 
        ...
        try:
            ...
            if update_next_version:
                ...
                patterns and self._commit(f'Update next version to \'{next_version}\' on the working branch \'{work_branch}\'.', *patterns)
    ...
    def _remove_branch(self, branch, *, check=False, remove_remote: bool=False):
        ...
        if remove_remote:
            ...
            self._execute(f'push --porcelain --progress --recurse-submodules=check origin :refs/heads/{branch}', check=check)
    ...
    def _push(self, branch):
        self._execute(f'push --porcelain --progress --recurse-submodules=check origin refs/heads/{branch}:refs/heads/{branch}')
